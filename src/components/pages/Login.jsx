...
function Login() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4">
      ...
      <div className="w-full max-w-5xl bg-white rounded-tl-2xl rounded-tr-2xl rounded-br-2xl rounded-bl-[65px] overflow-hidden shadow-lg flex">
        {/* Left Side - Promotional/Brand Section with matching rounded corners */}
        <div className="m-3 hidden md:flex md:w-1/2 bg-yellow-400 relative overflow-hidden rounded-tl-2xl rounded-tr-2xl rounded-br-2xl rounded-bl-[65px]">
